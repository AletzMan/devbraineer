...
export function Sidebar() {
    ...
    return (
        <aside className="relative z-50 w-67 hidden lg:block max-2xl:w-15 bg-base-100 h-svh overflow-y-auto overflow-x-hidden border-r-1 border-base-300 scrollbar-thin transition-all duration-100 group hover:max-2xl:w-67">
            <Link
                href="/"
