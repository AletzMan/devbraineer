...
export default function SectionCalculator({ title, description, children }: SectionCalculatorProps) {
    return (
        <section className="flex flex-col gap-4 h-[calc(100svh-14.5rem)] scrollbar-thin overflow-y-auto">
            ...
            <div className="px-4 py-2 ">
                <div className="flex flex-col gap-4 bg-base-300 rounded-sm">{children}</div>
            </div>
        </section>
    );
}
