...
export default function LogicSimulatorPage() {
    ...
    const [truthTable, setTruthTable] = useState<
        { a: boolean; b: boolean; c?: boolean; output: boolean }[]
    >([]);
            ...
            <div className="flex-1 max-w-6xl mx-auto p-4">
                <div className="mb-6">
                    ...
                    <p className="text-base-content/80">
                        ...
                        Simula y visualiza el comportamiento de compuertas
                        lógicas
                    </p>
                </div>
                    ...
                    <div className="space-y-6">
                        <div className="card bg-base-100 shadow-xl border border-base-content/20 backdrop-blur-sm">
                            <div className="card-body">
                                ...
                                <p className="text-base-content/80">
                                    Experimenta con diferentes compuertas
                                    lógicas y visualiza su comportamiento
                                </p>
                    ...
                    <div className="space-y-6">
                        <div className="card bg-base-100 shadow-xl border border-base-content/20 backdrop-blur-sm">
                            <div className="card-body">
                                ...
                                <p className="text-base-content/80">
                                    Visualiza todas las posibles combinaciones
                                    de entradas y salidas para la compuerta
                                    seleccionada
                                </p>
