                ...
                const fetchPosts = async () => {
                    try {
                        ...
                        if (response.data && response.data.error === false) {
                            ...
                            setError(
                                'Failed to load posts due to unexpected response format.'
                            );
                        }
                    } catch (err: any) {
        ...
        return (
            <div className="p-8 text-center flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
                <h1 className="text-4xl font-bold mb-6">
                    Bienvenido a DevBraineer
                </h1>
                <p className="text-xl mb-8">
                    La red social para ingenieros y desarrolladores.
                </p>
                <Link
                    href="/sign-in"
                ...
                <p className="mt-4 text-gray-400">
                    Conecta, aprende y comparte conocimiento técnico.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-3xl mx-auto bg-(--color-base-300) text-white min-h-screen border-l-1 border-r-1 border-(--color-base-100)">
            <header className="flex justify-between items-center px-4 py-2 border-b-1 border-(--color-base-100) ">
                <h1 className="text-2xl font-bold text-center text-(--color-base-content)">
                ...
                <div className="dropdown dropdown-bottom dropdown-end">
                    ...
                    <ul
                        ...
                        <li>
                            <button
                                onClick={() => handleCreatePost('Challenge')}>
                                <CodeIcon /> Reto
                            </button>
                        </li>
                        <li>
                            <button
                                onClick={() => handleCreatePost('Resource')}>
                        ...
                        <li>
                            <button
                                onClick={() => handleCreatePost('EventMeetup')}>
                                <CalendarIcon />
                                Evento
                            </button>
                        </li>
                    ...
                    {posts.map((post) => (
                        <div
                            ...
                            <div className="flex items-center justify-between mb-4">
                                ...
                                {post.publisher?.profile?.city &&
                                    post.publisher?.profile?.country && (
                                ...
                                <div
                                    ...
                                    {cloneElement(
                                        TypePost[PostType[post.type]]
                                            .icon as ReactSVGElement,
                                        { className: 'size-4' }
                                    )}
